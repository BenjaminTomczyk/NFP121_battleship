        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ExplosionLocationId = table.Column<int>(type: "int", nullable: true),
                    Hit = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    GameId = table.Column<int>(type: "int", nullable: true),
                    GameId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Explosion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Explosion_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Explosion_Game_GameId1",
                        column: x => x.GameId1,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Explosion_ExplosionLocationId",
                table: "Explosion",
                column: "ExplosionLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Explosion_GameId",
                table: "Explosion",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_Explosion_GameId1",
                table: "Explosion",
                column: "GameId1");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Explosion_Position_ExplosionLocationId",
                table: "Explosion",
                column: "ExplosionLocationId",
                principalTable: "Position",
                principalColumn: "Id",
